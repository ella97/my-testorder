...
export function DataTable<TData, TValue>({
  ...
  const [columnFilters, setCustomFilters] = React.useState<ColumnFiltersState>(
    []
  );
  ...
  const table = useReactTable({
    ...
    onColumnFiltersChange: setCustomFilters,
  ...
  useEffect(() => {
    if (setSelected) {
      ...
      //console.log(`Selected Flat: ${JSON.stringify(selectedRow)}`);
