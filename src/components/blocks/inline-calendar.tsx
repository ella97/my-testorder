  ...
  return (
    <div>
      <Calendar
        ...
        endMonth={endDate}
        className="w-fit overflow-hidden rounded-md p-0"
        classNames={{
          month_caption: "ms-2.5 me-0 justify-start",
          nav: "justify-end",
        }}
        components={{
...
function MonthGrid({
  ...
  return (
    <div className="relative">
      ...
      {isYearView && (
        <div className="bg-background absolute inset-0 z-20 -mx-2 -mb-2 w-full">
